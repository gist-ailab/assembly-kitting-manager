...
class Visualizer:
    ...
    def draw_instance_predictions(self, predictions):
        ...
        # "ikea_stefan_bracket", "ikea_stefan_bolt_side", "ikea_stefan_bolt_hip", "ikea_stefan_pin"]
        class_name = ['bracket', 'side', 'hip', 'pin']
    ...
    def draw_panoptic_seg_predictions(
        ...
        try:
            ...
            colors = [_COLORS[k] for k in category_ids]
        except AttributeError:
            colors = None
    ...
    def draw_dataset_dict(self, dic):
        ...
        if annos:
            ...
            # colors = None            
            colors = [_COLORS[k] for k in labels]
            # if self._instance_mode == ColorMode.SEGMENTATION and self.metadata.get("thing_colors"):
            #     colors = [
    ...
    def overlay_instances(
        ...
        *,
        ...
        if assigned_colors is None:
            assigned_colors = [_COLORS[11] for _ in range(num_instances)]
        ...
        for i in range(num_instances):
            ...
            if labels is not None:
                ...
                if boxes is not None:
                    x0, y0, x1, y1 = boxes[i]
                    text_pos = (x0, y0 - 15)  # if drawing boxes, put text on the box corner.
                    horiz_align = "left"
                elif masks is not None:
    ...
    def overlay_rotated_instances(self, boxes=None, labels=None, assigned_colors=None):
        ...
        if assigned_colors is None:
            ...
            assigned_colors = [_COLORS[k] for k in category_ids]
        if num_instances == 0:
            return self.output
