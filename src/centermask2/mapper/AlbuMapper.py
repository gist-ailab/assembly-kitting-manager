...
class AlbuMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        augm_annotation = self.aug(image=img, bboxes=boxes, masks=masks, category_id=labels)
        ...
        augm_masks = augm_annotation["masks"]
        ...
        dataset_dict["image"] = torch.as_tensor(img.transpose(2, 0, 1).astype("float32")).contiguous()
