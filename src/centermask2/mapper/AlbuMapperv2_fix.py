...
from pycococreateortools import binary_mask_to_polygon
...
CLASSES = ["N/A",'bracket', 'bolt_side', 'bolt_hip', 'pin']
...
transform = albumentations.Compose([
                        ...
                        albumentations.OneOf([
                            ...
                            albumentations.HueSaturationValue(hue_shift_limit=(0, 128), 
                        ...
                        #albumentations.RandomSizedCrop(min_max_height=(500, 720), height=720, width=1280, p=1),
                        #albumentations.augmentations.transforms.RandomSizedBBoxSafeCrop(height=720, width=1280, erosion_rate=0.5, p=1.0),
                        albumentations.augmentations.transforms.ImageCompression(quality_lower=50, quality_upper=100, always_apply=False, p=1.0),
